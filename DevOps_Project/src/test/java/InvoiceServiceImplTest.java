...
public class InvoiceServiceImplTest {
    ...
    public void testRetrieveInvoice() {
        ...
        assertEquals(invoice, retrievedInvoice);
                ...
                // Log success message
        System.out.println("testRetrievePInvoice() test passed: Product retrieved successfully.");
    }
    @Test
    public void testAssignOperatorToInvoice() {
        ...
        System.out.println("testAssignOperatorToInvoice() test passed: Product retrieved successfully.");
